...
/*************************for I2c bus******************************************************/
extern __u16 WireBegin(__u16 device);
extern __u16 WireBeginTransmission(__u16 device,__u8 addr);
extern __u16 WireWrite(__u16 device, __u8 data);
extern __u16 WireEndTransmission(__u16 device);
extern __u16 WireRequestFrom(__u16 device, __u8 addr, __u16 quantity);
extern __u16 WireAvailable(__u16 device);
extern __u8  WireRead(__u16 device);
extern __u8  WireEnd(__u16 device);
