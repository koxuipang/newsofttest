...
*>修改人:
*>日期:
*>描述: 实现ITEAD-PLUS对SIM900模块的支持头文件
*>备注: 
********************************************************************************/
#ifndef __GSM_Shield
#define __GSM_Shield
...
// pins definition
#define GSM_ON              39 // connect GSM Module turn ON to pin 77 
#define GSM_RESET           40// connect GSM Module RESET to pin 35
#define DTMF_DATA_VALID     41 // connect DTMF Data Valid to pin 14
#define DTMF_DATA0          42 // connect DTMF Data0 to pin 72
#define DTMF_DATA1          43 // connect DTMF Data1 to pin 73
#define DTMF_DATA2          44 // connect DTMF Data2 to pin 74
#define DTMF_DATA3          45 // connect DTMF Data3 to pin 75
